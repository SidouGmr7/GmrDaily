...
export const Dashboard = () => {
    ...
    return (
        <Layout
            ...
            defaultHideSideBar={isMobile}>
            {sideBarLink.map(({ components, link }, index) => {
                if (path === link)
                    return (
                        <motion.div variants={container} initial='hidden' animate='show' key={index}>
                            <Paper component={motion.div} variants={item} style={{ borderRadius: 40 }}>
